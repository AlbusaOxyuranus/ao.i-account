...
$directoryScripts =$directoryPath.Substring(0,$directoryPath.LastIndexOf('\'))+"\Data\ao.i-account.db\Scripts\";
$directoryScriptsConstraints =$directoryPath.Substring(0,$directoryPath.LastIndexOf('\'))+"\Data\ao.i-account.db\Scripts\Constraints";
$baseDirectoryOutput = $directoryPath.Substring(0,$directoryPath.LastIndexOf('\'))+"\Data\ao.i-account.db\";
$directoryScriptsStoredProcedures =$directoryPath.Substring(0,$directoryPath.LastIndexOf('\'))+"\Data\ao.i-account.db\dbo\Programmability\Stored Procedures";
